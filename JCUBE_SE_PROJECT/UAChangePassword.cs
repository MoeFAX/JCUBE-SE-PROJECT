...
namespace JCUBE_SE_PROJECT
{
    public partial class UAChangePassword : Form
    {
        ...
        private void SaveBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                cn.Open();
                cm = new SqlCommand("UPDATE tbUser SET password = @password WHERE username = @username", cn);
                cm.Parameters.AddWithValue("@username", CPUNlbl.Text);
                ...
                {
                    cm.Parameters.AddWithValue("@password", CPNewPasswordField.Text);
                    cm.ExecuteNonQuery();
                    cn.Close();
                    Clear();
